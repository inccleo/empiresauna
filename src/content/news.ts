...
export const NEWS: NewsPost[] = [
  {
    ...
    bodyEn: [
      ...
      "- **Lobby lounge** — Free to use; open 24 hours so you always have a place to rest.",
      ...
      "The venue is **open 24 hours**; therapists are on duty **17:00–06:00** (August 2026). Schedule the included 90-minute massage within duty hours; evening entry → bath → massage → late bite is the smoothest flow. On Shanghai Street, Macau Peninsula — see [location](/location/).",
      "## Want to upgrade? Menu ladder",
      "Above Sauna Entry: Southeast Asian MOP 3,088, Chinese MOP 3,988–4,388, European & American MOP 4,288–4,488, Japan·Korea·Taiwan MOP 5,988–6,388 — all without 10% service charge. See [pricing](/pricing/). Packages MOP 3,088+ booked via this site include two free \"extras\" — see [booking perks](/news/booking-perks/). Free city-wide private transfer and no entry fee apply at every tier (August 2026).",
      "## FAQ",
      "**How long can I stay on Sauna Entry?** Open 24 hours; exact stay arrangements are confirmed with you when booking.",
    ...
    bodyJa: [
      ...
      "## 来店時間の目安",
      "館内は**24時間営業**、セラピスト当番は**17:00〜翌06:00**（2026年8月）。付帯90分マッサージはこの時間内に。夕方入場→入浴→マッサージ→軽食がスムーズ。上海通り・マカオ半島 — [アクセス](/location/)。",
      "## アップグレード？メニュー段階",
      "浄サウナの上は東南アジア式 MOP 3,088、中式 MOP 3,988–4,388、欧米式 MOP 4,288–4,488、日韓台式 MOP 5,988–6,388。すべてサービス料なし。[料金](/pricing/)へ。MOP 3,088以上は当サイト予約で「小工」2つ無料 — [予約特典](/news/booking-perks/)。全区無料送迎・入場料無料は全ランク適用（2026年8月）。",
      "## よくある質問",
      "**浄サウナの滞在時間は？** 24時間営業。詳細は予約時に。",
    ...
    bodyKo: [
      ...
      "- **로비 라운지** — 무료. 24시간 영업으로 언제든 쉴 수 있습니다.",
      ...
      "## 방문 시간 제안",
      "매장은 **24시간 영업**, 테라피스트 근무는 **17:00~익일 06:00**(2026년 8월). 포함 90분 마사지는 이 시간 안에. 저녁 입장→목욕→마사지→야식이 가장 자연스럽습니다. 마카오 반도 상하이 거리 — [위치](/location/).",
      "## 업그레이드? 메뉴 단계",
      "정사우나 위는 동남아식 MOP 3,088, 중식 MOP 3,988–4,388, 구미식 MOP 4,288–4,488, 일한대식 MOP 5,988–6,388. 모두 봉사료 없음. [요금](/pricing/) 참고. MOP 3,088 이상은 본 사이트 예약 시 「소공」 2개 무료 — [예약 혜택](/news/booking-perks/). 전 지역 무료 픽업·입장료 무료는 모든 등급에 적용(2026년 8월).",
      "## FAQ",
      "**정사우나는 얼마나 머무를 수 있나요?** 24시간 영업. 상세는 예약 시.",
  ...
  },
  {
    ...
    bodyEn: [
      ...
      "## Shelter on site — 24-hour advantage",
      "Empire Sauna is open 24 hours (August 2026). Stormy nights are popular with regulars: marble dual baths, free dining, VIP recliner lounge for a nap.",
    ...
    bodyJa: [
      ...
      "## 館内で嵐を避ける — 24時間の強み",
      "巨亨は24時間営業（2026年8月）。風雨の夜は常連に人気：大理石双浴場、無料飲食、VIPリクライニングで仮眠。",
      "## 変更手数料なし",
    ...
    bodyKo: [
      ...
      "## 매장에서 피신 — 24시간 강점",
      "거헝은 24시간 영업(2026년 8월). 비바람 밤은 단골에게 인기: 대리석 쌍욕조, 무료 식사, VIP 리클라이너에서 쪽잠.",
      "## 변경 수수료 없음",
  ...
  },
  {
    ...
    excerptEn:
      "Empire Sauna is at Rua de Xangai 154 & 162 (Hoi Kuan Centre), open 24 hours. Routes from Border Gate, HZMB and Outer Harbour, late-night tips, first-visit flow, and free private transfer.",
    excerptJa:
      "巨亨サウナはマカオ上海通り154・162号（海冠中心）、24時間営業。関閘・港珠澳大橋・外港の3ルート、深夜来店、初回フロー、無料送迎を解説。",
    excerptKo:
      "거헝 사우나는 마카오 상하이 거리 154·162번(해관 센터), 24시간 영업. 관문·강주아오대교·외항 3개 루트, 심야 방문, 첫 방문 흐름, 무료 픽업 안내.",
    bodyHant: [
    ...
    bodyEn: [
      ...
      "## Late-night arrivals",
      "Open 24 hours (August 2026). Red-eye flights and last ferries are fine. Street taxis are scarce late — private transfer is more reliable.",
    ...
    bodyJa: [
      ...
      "## 深夜来店",
      "24時間営業（2026年8月）。深夜便・最終船も対応。深夜のタクシーは少ないので送迎が安心。",
      "## いちばん確実：無料送迎",
    ...
    bodyKo: [
      ...
      "## 심야 방문",
      "24시간 영업(2026년 8월). 새벽 항공편·막차 페리도 가능. 심야 택시가 적어 픽업이 더 안전.",
      "## 가장 확실한 방법: 무료 픽업",
