...
export const NEWS: NewsPost[] = [
  {
    ...
    bodyHant: [
      ...
      "## 想升級？菜單階梯這樣看",
      "以 2026 年 8 月現時菜單，淨桑之上為東南亞式 MOP 3,088 – 3,288、台式 MOP 3,988 – 5,288、歐美式 MOP 4,388 – 4,588、日韓寶島 MOP 5,788 – 5,988，全數免收 10% 服務費，詳見[價目頁](/pricing/)。選擇 MOP 3,088 或以上項目，經本站預約另可免費任選兩項「小工」加值服務 — 內容與熱門組合見[預約禮遇一覽](/news/booking-perks/)。無論選哪一級，澳門全區免費專車接送與免入場費均適用（2026 年 8 月現行禮遇）。",
      "## 常見問題",
    ...
    bodyHans: [
      ...
      "## 想升级？菜单阶梯这样看",
      "以 2026 年 8 月现时菜单，净桑之上为东南亚式 MOP 3,088 – 3,288、台式 MOP 3,988 – 5,288、欧美式 MOP 4,388 – 4,588、日韩宝岛 MOP 5,788 – 5,988，全数免收 10% 服务费，详见[价目页](/pricing/)。选择 MOP 3,088 或以上项目，经本站预约另可免费任选两项「小工」加值服务 — 内容与热门组合见[预约礼遇一览](/news/booking-perks/)。无论选哪一级，澳门全区免费专车接送与免入场费均适用（2026 年 8 月现行礼遇）。",
      "## 常见问题",
    ...
    bodyEn: [
      ...
      "Above Sauna Entry: Southeast Asian MOP 3,088 – 3,288, Taiwanese MOP 3,988–5,288, European & American MOP 4,388–4,588, Japan·Korea·Formosa MOP 5,788–5,988 — all without 10% service charge. See [pricing](/pricing/). Packages MOP 3,088+ booked via this site include two free \"extras\" — see [booking perks](/news/booking-perks/). Free city-wide private transfer and no entry fee apply at every tier (August 2026).",
      "## FAQ",
    ...
    bodyJa: [
      ...
      "## アップグレード？メニュー段階",
      "浄サウナの上は東南アジア式 MOP 3,088 – 3,288、台式 MOP 3,988–5,288、欧米式 MOP 4,388–4,588、日韓寶島 MOP 5,788–5,988。すべてサービス料なし。[料金](/pricing/)へ。MOP 3,088以上は当サイト予約で「小工」2つ無料 — [予約特典](/news/booking-perks/)。全区無料送迎・入場料無料は全ランク適用（2026年8月）。",
      "## よくある質問",
    ...
    bodyKo: [
      ...
      "## 업그레이드? 메뉴 단계",
      "정사우나 위는 동남아식 MOP 3,088 – 3,288, 대식 MOP 3,988–5,288, 구미식 MOP 4,388–4,588, 일한보도 MOP 5,788–5,988. 모두 봉사료 없음. [요금](/pricing/) 참고. MOP 3,088 이상은 본 사이트 예약 시 「소공」 2개 무료 — [예약 혜택](/news/booking-perks/). 전 지역 무료 픽업·입장료 무료는 모든 등급에 적용(2026년 8월).",
      "## FAQ",
